...
public class Product {
    ...
    public Product(String pro_name, String pro_num, double market_price, double shop_price, String pro_color, int pro_total_count, String pro_max_img, String pro_min_img, int pro_state) {
        this.pro_name = pro_name;
        this.pro_num = pro_num;
        this.market_price = market_price;
        this.shop_price = shop_price;

...
<table width="100%">
    ...
    <tr>
            ...
            <c:forEach items="${sessionScope.cart}" var="entry">
                <tr>
                    ...
                    <td width="10%" style="border-right: 1px solid gray;">
                        <input type="text" name="quantity" value="${entry.value}" maxlength="4" size="10" readonly>
                    </td>
                    <td width="15%" style="border-right: 1px solid gray;">
                        <span class="subtotal">￥:${entry.key.shop_price*entry.value}</span>
                    </td>
                    <td style="border-right: 1px solid gray;">
                        <a href="${pageContext.request.contextPath}/CartServlet?method=deleteCartById&proId=${entry.key.pro_id}" class="delete">删除</a>
                    </td>
                </tr>
            </c:forEach>
        ...
        <table style="margin:0 auto; margin-top:10px;width:950px;">
            ...
            <tr>
                <td style="text-align: right" colspan="100%">
                    商品金额: <strong style="color:#ff6600;">￥:${sessionScope.sum}元</strong>
        ...
        <table style="margin:0 auto; margin-top:10px;width:950px;">
            ...
            <tr>
                <td style="text-align: right" colspan="100%">
                    <a style="color: blue" href="${pageContext.request.contextPath}/JSP/index.jsp">继续购物</a>&nbsp;&nbsp;&nbsp;
                    <a href="${pageContext.request.contextPath}/PayServlet?method=pay">
